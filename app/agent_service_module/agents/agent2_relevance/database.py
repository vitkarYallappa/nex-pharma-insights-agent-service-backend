...
class Agent2RelevanceRepository(BaseRepository):
    """Database operations for agent2_relevance."""
    
    def __init__(self):
        super().__init__(table_name="agent2_relevance_data")
    
    def get_table_name(self) -> str:
        return "agent2_relevance_data"
