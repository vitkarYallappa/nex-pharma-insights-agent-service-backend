...
class Stage0PerplexityStorage:
    """Legacy storage operations for stage0_perplexity - maintained for backward compatibility"""
    ...
    async def save_result(self, request_id: str, data: dict) -> bool:
        ...
        try:
            object_key = f"stage0_perplexity/results/{request_id}.json"
